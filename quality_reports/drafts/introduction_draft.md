...
- **[CITE]** Bennis and Nanus (1985) — "Leaders: The Strategies for Taking Charge" — original VUCA source
- **[CITE]** Bennett and Lemoine (2014) — HBR, "What VUCA Really Means for You"
- **[CITE]** Baker, Bloom, Davis (2016) — EPU, QJE
- **[CITE]** Blei, Ng, Jordan (2003) — LDA, JMLR
- Consider adding 1–2 sentences on the literature gap more explicitly (what prior work has NOT done)
- Section 2 (literature review) is not drafted here — add before submission
